...
if (isset($_SESSION['logged']) && $_SESSION['logged'] == true) {
    ...
    if (isset($_GET['type']) && $_GET['type'] == "add") {
        ...
        if ($result) {
            $_SESSION['msg'] = '<div class="alert alert-success glass-alert mb-2" role="alert"><i class="fas fa-check-circle me-2"></i> Subject Added Successfully.</div>';
    ...
    if (isset($_GET['type']) && $_GET['type'] == "delete") {
        ...
        $result = mysqli_query($conn, $sql);
        if ($result) {
            $_SESSION['msg'] = '<div class="alert alert-success glass-alert mb-2" role="alert"><i class="fas fa-trash-alt me-2"></i> Subject Deleted.</div>';
            header("location: subject_details.php");
            exit();
        } else {
            $_SESSION['msg'] = '<div class="alert alert-danger glass-alert mb-2" role="alert"><i class="fas fa-times-circle me-2"></i> Something went wrong!.</div>';
    ...
    if (isset($_GET['type']) && $_GET['type'] == "update") {
        ...
        $result = mysqli_query($conn, $sql);
        if ($result) {
            $_SESSION['msg'] = '<div class="alert alert-success glass-alert mb-2" role="alert"><i class="fas fa-check-circle me-2"></i> Subject Details Updated.</div>';
            header("location: subject_details.php");
            exit();
        } else {
            $_SESSION['msg'] = '<div class="alert alert-danger glass-alert mb-2" role="alert"><i class="fas fa-times-circle me-2"></i> Something went wrong!.</div>';
