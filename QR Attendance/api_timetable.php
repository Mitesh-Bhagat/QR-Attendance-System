...
if (isset($_SESSION['logged']) && $_SESSION['logged'] == true) {
    ...
    if (isset($_GET['type']) && $_GET['type'] == "add") {
        ...
        if ($eresult->num_rows == 0) {
            ...
            $_SESSION['msg'] = '<div class="alert alert-success glass-alert mb-2" role="alert"><i class="fas fa-check-circle me-2"></i> Time Table Set Successfully.</div>';
            header("location: timetable.php");
            exit();
        } else {
            $_SESSION['msg'] = '<div class="alert alert-warning glass-alert mb-2" role="alert"><i class="fas fa-exclamation-triangle me-2"></i> Time Table Already Exists.</div>';
            header("location: timetable.php");
            exit();
        }
    }
    ...
    if (isset($_GET['type']) && $_GET['type'] == "delete") {
        ...
        if ($eresult->num_rows > 0) {
            ...
            $_SESSION['msg'] = '<div class="alert alert-success glass-alert mb-2" role="alert"><i class="fas fa-trash-alt me-2"></i> Time Table Deleted.</div>';
            header("location: timetable.php");
            exit();
        } else {
            $_SESSION['msg'] = '<div class="alert alert-warning glass-alert mb-2" role="alert"><i class="fas fa-search-minus me-2"></i> Time Table Not Found.</div>';
            header("location: timetable.php");
            exit();
        }
    }
